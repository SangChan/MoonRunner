...
//  MoonRunner
//
//  Created by SangChan on 2014. 9. 17..
...
- (void)viewDidLoad {
    ...
    if (self.earnStatus.silverRun) {
        ...
        self.silverLabel.text = [NSString stringWithFormat:@"Pace < %@ for silver!", [MathController stringifyAvgPaceFromDist:(self.earnStatus.earnRun.distance.floatValue * silverMulitiplier) overTime:self.earnStatus.earnRun.duration.intValue]];
    }
    ...
    if (self.earnStatus.goldRun) {
        ...
        self.goldLabel.text = [NSString stringWithFormat:@"Pace < %@ for gold!", [MathController stringifyAvgPaceFromDist:(self.earnStatus.earnRun.distance.floatValue * goldMulitiplier) overTime:self.earnStatus.earnRun.duration.intValue]];
    }
